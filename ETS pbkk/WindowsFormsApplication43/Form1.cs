...
namespace WindowsFormsApplication43
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string uri = string.Format("http://api.weatherapi.com/v1/forecast.xml?key=2a82a33a16ba4e5195c33250230404&q={0}&days=1&aqi=no&alerts=no", city);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string uri = string.Format("http://api.weatherapi.com/v1/forecast.xml?key=2a82a33a16ba4e5195c33250230404&q={0}&days=7&aqi=no&alerts=no", city);
